...
def spNaN(month, variable, data):
    ...
    #return plt.show()
#check
spNaN('12','avg_2m_temperature', dataframes) #248
spNaN('12','avg_10m_v_component_of_wind', dataframes) #248
spNaN('12','avg_surface_pressure', dataframes) #248
spNaN('12','prcp_total', dataframes) #248
...
def removeNaN(data):
    ...
    for key, df in data.items():
        ...
        df.to_csv(f'CSVafterClean/_{key}.csv', index=False)
    # Now 'dataframes' contains your dataframes as pandas dataframes
    return data
